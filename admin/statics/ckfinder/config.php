...
if($_SERVER['HTTP_HOST'] == 'admin.cinars.org') {
	$config['LicenseName'] = 'admin.cinars.org';
	$config['LicenseKey'] = '';
} else {
	$config['LicenseName'] = 'admin.cinars.org';
	$config['LicenseKey'] = '';
...
if($_SERVER['HTTP_HOST'] == 'admin.local.cinars.org') $baseUrl = 'http://local.cinars.org/statics/files/';
else if ($_SERVER['HTTP_HOST'] == 'admin.cinars.dev.commun.ca') $baseUrl = 'http://cinars.dev.commun.ca/statics/files/';
else $baseUrl = 'http://cinars.org/statics/files/';
...
*/
//$baseDir = resolveUrl($baseUrl);
$baseDir = dirname(__FILE__).'/../../../public_html/statics/files/';
